 ...
 *  @author Kevin Wayne
 */
public class EdgeWeightedDigraphProj {
    ...
    public EdgeWeightedDigraphProj(int V, int E) {
        ...
        for (int i = 0; i < E; i++) {
            ...
            DirectedEdgeProj e = new DirectedEdgeProj(v, w, weight);
            addEdge(e);
        }
    }
     ...
     */
    public EdgeWeightedDigraphProj(In in) {
        ...
        try {
            ...
            for (int i = 0; i < E; i++) {
                ...
                addEdge(new DirectedEdgeProj(v, w, weight));
            }
        }
     ...
     */
    public EdgeWeightedDigraphProj(EdgeWeightedDigraphProj G) {
        this(G.V());
        this.E = G.E();
        for (int v = 0; v < G.V(); v++)
        ...
        for (int v = 0; v < G.V(); v++) {
            ...
            Stack<DirectedEdgeProj> reverse = new Stack<DirectedEdgeProj>();
            for (DirectedEdgeProj e : G.adj[v]) {
                reverse.push(e);
            }
            for (DirectedEdgeProj e : reverse) {
                adj[v].add(e);
            }
        }
    }
